...
import com.homebanking.tpint.excepcion.DniInvalido;
import com.homebanking.tpint.excepcion.fechaInvalida;
import com.homebanking.tpint.excepcion.validacion;
...
import com.homebanking.tpint.negocio.ReporteNeg;
...
import com.homebanking.tpint.negocioimpl.PrestamoNegImpl;
import com.homebanking.tpint.negocioimpl.ReporteNegImpl;
			...
			if(listaPrestamos.size()==0) {
				...
				for (int i = 0; i < listaPrestamos.size(); i++) {
				    ...
				    jsonBuilder.append("{")
				                ...
				                .append("\"estado\":").append(prestamo.getEstado().getId()) // Aseg�rate de ajustar seg�n tu estructura
				                .append("}");
